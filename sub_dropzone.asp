<%
if tipo_allegato="" then tipo_allegato=request.form("tipo_allegato")
if id_tipo_allegato="" then id_tipo_allegato=request.form("id_tipo_allegato")
%>
...
<script type='text/javascript'>
	...
	posizione_errore="qui4";
	
	function aggiorna_elenco_files(){
		    posizione_errore="qui3";

        $.ajax({
            url: "sub_allegati_ajax.asp",
            type: "post",
            cache: false,
            data: { tipo_allegato: tipo_allegato,id_tipo_allegato: id_tipo_allegato, noscript:'noscript'},
