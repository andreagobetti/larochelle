...
(function ($) {
	...
	var Venedor = {
		...
		itemHoverAnimation: function () {
			var self = this;
			console.log("itemHoverAnimation");
		...
		productZoomImage: function () {
            ...
            if($.fn.elastislide && carouselContainer.find('li').length > 4) {
			...
			if ($.fn.elevateZoom) {
				...
				$('#product-image').elevateZoom({
					...
					zoomType: ( self.mobile || $(window).width() < 768 ) ? 'inner' : 'window', // you can use 'inner' or 'window' // change inner and go to product.html page and see zoom plugin differances
					zoomWindowPosition: 1, zoomWindowOffetx: 10,scrollZoom : true
		...
		owlCarousels: function () {
			...
			/* Also purchased slider - product.html */
			var  categoriaItems = $('.categoria-items-slider.owl-carousel');
			if (self.checkSupport(categoriaItems, $.fn.owlCarousel)) {
		        categoriaItems.owlCarousel({
		            items: 4,
		            itemsDesktop : [1199,4],
		            itemsDesktopSmall: [979,3],
		            itemsTablet: [768,2],
		            ...
		            mouseDrag: false,
		            autoHeight : true
		        }).data('navigationBtns', ['#categoria-items-slider-prev', '#categoria-items-slider-next']);
		    }
		...
		tooltip: function () {
			// Bootstrap tooltip
			if($.fn.tooltip) {
				$('.add-tooltip').tooltip({ container: 'body',placement: 'right' }) ;
			}
		},
		popover: function () {
			// Bootstrap tooltip
