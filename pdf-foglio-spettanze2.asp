...
'---------------------------------------------	
'V2.00 allarga la pagina in base ai dipendenti
'---------------------------------------------
...
rs.close
	...
	const maxdip=15
	cicli=ubound_arrDipendenti/maxdip
	if ubound_arrDipendenti mod maxdip>0 then clicli = cicli +1
	
	Page.width= (ubound_arrDipendenti*26)+200
