...
'	https://code.google.com/archive/p/aspjson/downloads
...
Class jsCore
	...
	'Output JSON, response.write js.jsString
...
Function QueryToJSON(rs)
        ...
        While Not (rs.EOF Or rs.BOF)
                ...
                For Each col In rs.Fields
	                	tmp=col.Value
	                	if not isnull(tmp) then Server.HTMLEncode(tmp)
                        jsa(Null)(col.Name) =    tmp
                Next
        rs.MoveNext
        Wend
        Set QueryToJSON = jsa
