...
for ciclo = 1 to cicli
	...
	if cicli=1 then
		...
		if ciclo<cicli then
			...
			'Ultima pagina
			colDip= ubound_arrDipendenti -( (dipperpagina+1)*(cicli-1))
	...
	sql="select idpro, codice_ordine as codice, articolo_ordine as articolo, prezzo, iddett, quantita from ordini_dett where idord="&idord&"  order by ordine"
...
function offsDip(ciclo,n)
	...
	offsDip=(ciclo-1)*(dipperpagina+1)+n
end function
