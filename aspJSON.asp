<%
'December 2013 - Version 1.13 by Gerrit van Kuipers
Class aspJSON
	Public data
	Private p_JSONstring
	Private p_datatype
	private aj_in_string, aj_in_escape, aj_i_tmp, aj_char_tmp, aj_s_tmp, aj_line_tmp, aj_line, aj_lines, aj_currentlevel, aj_currentkey, aj_currentvalue, aj_newlabel, aj_XmlHttp, aj_RegExp
	...
	Public Sub loadJSON(inputsource)
		inputsource = MultilineTrim(inputsource)
	...
	Private Function MultilineTrim(TextData)
		MultilineTrim = aj_RegExp.Replace(TextData, "$1")
	End Function
End Class
%>