...
'--EMAIL----EMAIL----EMAIL----EMAIL----EMAIL----EMAIL----EMAIL----EMAIL----EMAIL----EMAIL----EMAIL----EMAIL----EMAIL----EMAIL----EMAIL----EMAIL--
		...
		objMessage.HtmlBody = "<!DOCTYPE HTML PUBLIC ""-//IETF//DTD HTML//EN""><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head><meta http-equiv=""Content-Type""<title></title></head><body>"&HTML&"</body></html>"
		objMessage.Send
...
sql=sql & " HAVING (((Ticket.id_user)="& session("iduser") &") and  ((Ticket.data_chiusura) Is Null)  ) "
...
%>
        <table width="100%" border="0" cellpadding="2" cellspacing="0" class="tabella1">
          <tr>
            <td colspan="5" class="ui-widget-header">Elenco promemoria</td>
          </tr>
          <tr align="right">
            <td colspan="5" style="border-bottom:1px solid;"><a href="<%=questofile%>?oper=new"><strong>Nuovo promemoria</strong></a></td>
          </tr>
          <tr>
            ...
            <td bgcolor="#E5E5E5" style="border-bottom:1px solid;">Messaggi</td>
            <td bgcolor="#E5E5E5" style="border-bottom:1px solid;">Data ultimo messaggio</td>
          </tr>
          <%
...
%>
        <table width="100%" border="0" cellpadding="2" cellspacing="0" class="tabella1">
          <tr>
            <td class="ui-widget-header">Promemoria</td>
          </tr>
          <tr align="left">
	...
	%>
          <tr align="left">
            <td align="center" bgcolor="#E5E5E5" style="border-bottom:1px solid;"><form name="form1" method="post" action="<%=Request.ServerVariables("Script_Name")%>" style="margin-top:0px;">
                ...
                <input type="submit" name="invio" value="Elimina promemoria">
              </form></td>
          </tr>
          <%end if%>
        </table>
  ...
  return (true); 
        ...
        <form name="form1" method="post" action="<%=Request.ServerVariables("Script_Name")%>"  onSubmit="return Validator(this)" style="margin-top:0px;">
          ...
          <table width="100%" border="0" cellpadding="2" cellspacing="0" class="tabella1">
            ...
            <% if oper="new" then%>
            <tr>
              <td align="right" valign="top">Oggetto</td>
